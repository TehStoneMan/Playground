...
import io.github.tehstoneman.playground.common.fluid.LiquidFartFluid;
...
public class PlaygroundBlocks
{
	...
	public static final RegistryObject< FlowingFluidBlock >	LIQUID_FART		= BLOCK_REGISTER.register( "liquid_fart",
			() -> new FlowingFluidBlock( PlaygroundFluids.LIQUID_FART, AbstractBlock.Properties.of( LiquidFartFluid.MATERIAL_FART ) ) );
}
